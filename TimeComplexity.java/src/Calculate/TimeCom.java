...
public class TimeCom {
    public double Quadratic(double seconds,double inputs,double inputs2){
       double r = ((inputs2 * inputs2) * seconds) /(inputs*inputs);
        return Double.parseDouble(String.format("%.3f", r));
    }

    public double Cubic(double seconds,double inputs,double inputs2){
        double r1 = ((inputs2 * inputs2*inputs2) * seconds) /(inputs*inputs*inputs);
        return Double.parseDouble(String.format("%.3f", r1));
    }
    ...
    public double Linear(double seconds,double inputs,double inputs2){
        double re =(inputs2 * seconds)/inputs;
        return Double.parseDouble(String.format("%.3f", re));
    }
